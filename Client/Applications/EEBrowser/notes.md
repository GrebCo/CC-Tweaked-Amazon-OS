# Fizzle
### script functions
- [X] Send/Query (sanitized clientnetworkhandler.lua)
...
- [X] Browser needs to create ui elements based on the minimark file, and then bind those elements to fizzle functions.