...
if remoteVersion ~= version then
    ...
    shell.run("wget https://raw.githubusercontent.com/GrebCo/CC-Tweaked-Amazon-OS/refs/heads/dev/Elliot/EENet/Client/OSUtil/UI.lua OSUtil/UI.lua")
    shell.run("wget https://raw.githubusercontent.com/GrebCo/CC-Tweaked-Amazon-OS/refs/heads/dev/Elliot/EENet/Client/OSUtil/ClientNetworkHandler.lua OSUtil/ClientNetworkHandler.lua")
    shell.run("wget https://raw.githubusercontent.com/GrebCo/CC-Tweaked-Amazon-OS/refs/heads/dev/Elliot/EENet/Client/OSUtil/events.lua OSUtil/events.lua")
    shell.run("wget https://raw.githubusercontent.com/GrebCo/CC-Tweaked-Amazon-OS/refs/heads/dev/Elliot/EENet/Client/OSUtil/Logger.lua OSUtil/Logger.lua")

    print("Downloading OSUtil/UI files...")
    shell.run("wget https://raw.githubusercontent.com/GrebCo/CC-Tweaked-Amazon-OS/refs/heads/dev/Elliot/EENet/Client/OSUtil/UI/UI.lua OSUtil/UI/UI.lua")
    shell.run("wget https://raw.githubusercontent.com/GrebCo/CC-Tweaked-Amazon-OS/refs/heads/dev/Elliot/EENet/Client/OSUtil/UI/Inputs.lua OSUtil/UI/Inputs.lua")
    shell.run("wget https://raw.githubusercontent.com/GrebCo/CC-Tweaked-Amazon-OS/refs/heads/dev/Elliot/EENet/Client/OSUtil/UI/dataDisplay.lua OSUtil/UI/dataDisplay.lua")
    shell.run("wget https://raw.githubusercontent.com/GrebCo/CC-Tweaked-Amazon-OS/refs/heads/dev/Elliot/EENet/Client/OSUtil/UI/themes.lua OSUtil/UI/themes.lua")
